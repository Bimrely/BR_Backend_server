...
passport.use(
  new LinkedInStrategy(
    {
      clientID: '782061rri2cvea', // Replace with your LinkedIn app client ID
      clientSecret: 'WPL_AP1.x4Sjhfi8HiHMTjAk.RoyQYg==', // Replace with your LinkedIn app client secret
      callbackURL: 'https://br-backend-server.vercel.app/auth/linkedin/callback',
      scope: ['openid', 'email', 'profile'], // Updated scopes for OpenID Connect
    ...
    async (accessToken, refreshToken, profile, done) => {
      try {
        const userData = {
          ...
          email: profile.emails[0]?.value || '', // Make sure to handle cases where email is not provided
          accessToken,
          refreshToken,
        };
